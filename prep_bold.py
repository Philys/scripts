...
bold_files = glob.glob('%s/sub-*/func/sub-*_task-objectcategories_run-*_bold.nii.gz'%(path))
 
# I'm using a big html file to put all QA info together.  If you have other suggestions, let me know!
outhtml = "/Users/Phili/Documents/Abschlussarbeit_Seminar_Datenanalyse/Aufgabe_1/Datensatz/scripts/bold_motion_QA.html"
out_bad_bold_list = "/Users/Phili/Documents/Abschlussarbeit_Seminar_Datenanalyse/Aufgabe_1/Datensatz/scripts/subs_lose_gt_45_vol_scrub.txt"
